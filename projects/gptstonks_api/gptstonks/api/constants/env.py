...
try:
    AUTOLLAMAINDEX_REMOTE_VECTOR_STORE_API_KEY: str = os.environ[
        "AUTOLLAMAINDEX_REMOTE_VECTOR_STORE_API_KEY"
    ]
except KeyError:
    warnings.warn("AUTOLLAMAINDEX_REMOTE_VECTOR_STORE_API_KEY env variable not provided")
    AUTOLLAMAINDEX_REMOTE_VECTOR_STORE_API_KEY = None
